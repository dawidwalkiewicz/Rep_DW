<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nice1Liga.aspx.cs" Inherits="Projekt_01.Nice1Liga" %>
...
<body>
    ...
    <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="~/ListyKlubow/ListaKlubowNice1Ligi.xml">
    </asp:XmlDataSource>
    <asp:XmlDataSource ID="XmlDataSource2" runat="server" DataFile="~/ListyKlubow/ListaKlubowNice1Ligi.xml">
    </asp:XmlDataSource>
    </form>
</body>
</html>
