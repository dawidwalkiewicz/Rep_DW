<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LOTTOEkstraklasa.aspx.cs" Inherits="Projekt_01.WebForm1" %>
...
<body>
    ...
    <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="~/ListyKlubow/ListaKlubowLOTTOEkstraklasy.xml">
    </asp:XmlDataSource>
    <asp:XmlDataSource ID="XmlDataSource2" runat="server" DataFile="~/ListyKlubow/ListaKlubowLOTTOEkstraklasy.xml">
    </asp:XmlDataSource>
    </form>
</body>
</html>